...
namespace ARACI
{
    public partial class Nivel3_numero8 : Form
    {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            if (progressBar1.Value == progressBar1.Maximum)
            {
                ...
                MessageBox.Show("Você não conseguiu atingir o número 8", "Fim de jogo");
                this.Close();
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            if (timer1.Enabled == true)
            {
                ...
                MessageBox.Show("Você conseguiu acertar o número 8. Parabéns!!", "fim de jogo");
                progressBar1.Value = 0;
                Icon a = Properties.Resources.alvo;
                this.Cursor = new Cursor(a.Handle);
                atualizarPontuacao();
                ...
                Nivel3_numero9 numero9 = new Nivel3_numero9();
                numero9.Usuario = usuario;
                numero9.Show();
                Hide();
            }
            else
        ...
        {
            Nivel3_numero7 nivel_7 = new Nivel3_numero7(); 
            nivel_7.Show();
            Hide();
        }
    }
