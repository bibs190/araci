...
namespace ARACI
{
    public partial class Nivel3_numero1 : Form
    {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            if (progressBar1.Value == progressBar1.Maximum)
            {
                ...
                MessageBox.Show("Você não conseguiu atingir o número 1", "Fim de jogo");
                this.Close();
            }
        }
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            if (timer1.Enabled == true)
            {
                ...
                MessageBox.Show("Você conseguiu acertar o número 1. Parabéns!!", "fim de jogo");
                progressBar1.Value = 0;
                Icon a = Properties.Resources.alvo;
                this.Cursor = new Cursor(a.Handle);
                atualizarPontuacao();
        ...
        {
            Nivel3_numero0 numero0 = new Nivel3_numero0();
            numero0.Show();
            this.Hide();
        }

        private void Nivel3_numero1_Load(object sender, EventArgs e)
        {
