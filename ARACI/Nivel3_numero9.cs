...
namespace ARACI
{
    public partial class Nivel3_numero9 : Form
    {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            if (progressBar1.Value == progressBar1.Maximum)
            {
                ...
                MessageBox.Show("Você não conseguiu atingir o número 9", "Fim de jogo");
                this.Close();
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            if (timer1.Enabled == true)
            {
                ...
                MessageBox.Show("Você conseguiu acertar o número 9. Parabéns!!", "fim de jogo");
                progressBar1.Value = 0;
                Icon a = Properties.Resources.alvo;
                this.Cursor = new Cursor(a.Handle);
                atualizarPontuacao();
                ...
                MessageBox.Show("Parabéns !!! Você conseguiu completar o nével 3 com sucesso !!!", "");
                Close();
            }
            else
            {
        ...
        {
            Nivel3_numero8 nivel_8 = new Nivel3_numero8();
            nivel_8.Show();
            Hide();
        }
    }
